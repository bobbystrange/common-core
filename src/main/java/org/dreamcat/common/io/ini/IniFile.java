...
public class IniFile {
    ...
    public IniFile defaultSection(String defaultSection) {
        this.defaultSection = defaultSection;
        return this;
    }

    public IniFile sectionIgnoreCase(boolean sectionIgnoreCase) {
        this.sectionIgnoreCase = sectionIgnoreCase;
        return this;
    }

    public IniFile nameIgnoreCase(boolean nameIgnoreCase) {
        this.nameIgnoreCase = nameIgnoreCase;
        return this;
    }

    public IniFile failedIfInvalid(boolean failedIfInvalid) {
        this.failedIfInvalid = failedIfInvalid;
        return this;
    }

    public IniFile richText(boolean richText) {
